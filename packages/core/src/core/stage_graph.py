...
_MEETING_SYNC_ADDENDUM = (
    ...
    "   - Новая → tracker_create_issue. При duplicate_found сравни planned_create с существующей "
    "задачей и сам реши: UpdateIssue / CreateComment / ChangeIssueStatus или только отчёт.\n"
